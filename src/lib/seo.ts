const italianProvinces = [
  ...
  "Firenze", "Foggia", "Forli-Cesena", "Frosinone", "Genova", "Gorizia", "Grosseto",
  "Imperia", "Isernia", "La Spezia", "L'Aquila", "Latina", "Lecce", "Lecco", "Livorno",
  "Lodi", "Lucca", "Macerata", "Mantova", "Massa-Carrara", "Matera", "Messina", "Milano",
  "Modena", "Monza e della Brianza", "Napoli", "Novara", "Nuoro", "Oristano", "Padova",
  "Palermo", "Parma", "Pavia", "Perugia", "Pesaro e Urbino", "Pescara", "Piacenza", "Pisa",
...
export const localSoftwareKeywords = italianProvinces.flatMap((province) => [
  `sviluppo software ${province}`,
  `programmazione software ${province}`,
]);